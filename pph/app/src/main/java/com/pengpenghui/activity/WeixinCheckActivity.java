 ...
 */
public class WeixinCheckActivity extends Activity {
    ...
    private void findView(){
        ...
        inflaterDl = LayoutInflater.from(WeixinCheckActivity.this);
        layout_dia =(LinearLayout)inflaterDl.inflate(R.layout.dialog_instru_layout, null);
        dialog = new AlertDialog.Builder(WeixinCheckActivity.this).create();
        show_dia();
    }
    private void setListener(){
        bn_sure_weixin.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(code.isEmpty()){
                    Toast.makeText(WeixinCheckActivity.this,"请绑定码",Toast.LENGTH_SHORT).show();
                }else{
                    giftManager.bindWx(code, new ContextCallback() {
                        @Override
                        public void response(int state, Object object) {
                            if (state == SUCC) {
                                Toast.makeText(WeixinCheckActivity.this,"绑定成功",Toast.LENGTH_SHORT).show();
                            }else{
                                Toast.makeText(WeixinCheckActivity.this,""+object,Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
        ...
        bn_return_weixin.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                WeixinCheckActivity.this.finish();
            }
