 ...
 */
public class RepersonActivity extends Activity{
    ...
    private void setListener(){
        ...
        regi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final String newps = et_re_person_nps.getText().toString();
                ...
                if (oldps.isEmpty()||newps.isEmpty()||rnewps.isEmpty()){
                    Toast.makeText(RepersonActivity.this,"密码修改输入框为空",Toast.LENGTH_SHORT).show();
                }else{
                    if (oldps.equals(userModel.getPassWord())){
                        if (newps.equals(rnewps)){
                            mainPageController.changePassword(oldps, newps, new ContextCallback() {
                                @Override
                                public void response(int state, Object object) {
                                    userModel.setPassWord(newps);
                                }
                            });
                        }else{
                            Toast.makeText(RepersonActivity.this,"密码不一致",Toast.LENGTH_SHORT).show();
                        }
                    }else{
                        Toast.makeText(RepersonActivity.this,"原密码错误",Toast.LENGTH_SHORT).show();
                    }
                }
