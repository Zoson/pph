                    ...
                    if (password.equals(password_repeat)){
                        logController.tryReg(account, password, nickName, new ContextCallback() {
                            ...
                            public void response(int state, Object object) {
                                if (state == SUCC){
                                    Toast.makeText(Activity_Register.this, "注册成功" + object, Toast.LENGTH_SHORT).show();
                                    LayoutInflater inflaterDl = LayoutInflater.from(Activity_Register.this);
                                    LinearLayout layout =(LinearLayout)inflaterDl.inflate(R.layout.dialog_instru_layout, null);
                                    final Dialog dialog = new AlertDialog.Builder(Activity_Register.this).create();
                                    dialog.show();
                                    ...
                                    Toast.makeText(Activity_Register.this,""+object, Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }else{
